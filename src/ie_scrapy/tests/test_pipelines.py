...
class TestCleaningPipeline(TestBase):
    ...
    def test_clean_location(self):
        ...
        self.assertEqual(self.cp._clean_location('diversas ciudades de Madrid'), 'Madrid')
        self.assertEqual(self.cp._clean_location('diversas localidades de Madrid'), 'Madrid')
        self.assertEqual(self.cp._clean_location('diversas ubicaciones en Madrid'), 'Madrid')
        self.assertEqual(self.cp._clean_location('diversas ubicaciones por todo Madrid'), 'Madrid')
        self.assertEqual(self.cp._clean_location('cerca de Madrid'), 'Madrid')
        self.assertEqual(self.cp._clean_location('cerca de Madrid'), 'Madrid')
        self.assertEqual(self.cp._clean_location('cerca del Norte de Madrid'), 'Madrid')
        self.assertEqual(self.cp._clean_location('alrededores del centro de Madrid'), 'Madrid')
