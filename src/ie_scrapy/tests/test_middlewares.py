...
class TestERDownloaderMiddleware(TestCase):
    ...
    def test_process_request(self):
        ...
        try:
            exception = None
            TestERDownloaderMiddleware.erdm.process_request(request, None)
        except IgnoreRequest as e:
            exception = e
        finally:
            self.assertIsInstance(exception, IgnoreRequest)
        request = FakeRequest.get_valid_request('http://test')
        self.assertIsNone(TestERDownloaderMiddleware.erdm.process_request(request, None))

    def test_make_the_request_again(self):
        request = FakeRequest.get_valid_request('http://test')
        request_ = TestERDownloaderMiddleware.erdm._make_the_request_again(request)
        ...
        try:
            exception = None
            TestERDownloaderMiddleware.erdm._make_the_request_again(request)
        except IgnoreRequest as e:
            exception = e
        finally:
            self.assertIsInstance(exception, IgnoreRequest)
    ...
    def test_check_proxy_and_ua(self):
        ...
        TestERDownloaderMiddleware.erdm._check_proxy_and_ua(request, response)
    ...
    def test_process_exception(self):
        ...
        self.assertIsNone(TestERDownloaderMiddleware.erdm.process_exception(request, None, None))
        self.assertEqual(PUADownloaderMiddleware.proxy, request.meta.get('proxy_source'))
        self.assertEqual(PUADownloaderMiddleware.ua, request.headers.get(b'User-Agent'))
        request = FakeRequest.get_valid_request('http://test')
        self.assertIsNone(TestERDownloaderMiddleware.erdm.process_exception(request, IgnoreRequest(), None))
        self.assertEqual(PUADownloaderMiddleware.proxy, request.meta.get('proxy_source'))
        self.assertEqual(PUADownloaderMiddleware.ua, request.headers.get(b'User-Agent'))
        # Other Exception
        request = FakeRequest.get_valid_request('http://test')
        request_ = TestERDownloaderMiddleware.erdm.process_exception(request, Exception(), None)
        self.assertIsInstance(request_, Request)
        self.assertEqual(request_.meta.get('retry'), 1)
        self.assertIsNone(PUADownloaderMiddleware.proxy)
        self.assertIsNone(PUADownloaderMiddleware.ua)
        ...
        try:
            exception = None
            TestERDownloaderMiddleware.erdm.process_exception(request, Exception(), None)
        except IgnoreRequest as e:
            exception = e
        finally:
            self.assertIsInstance(exception, IgnoreRequest)
    ...
    def test_process_response(self):
        ...
        self.assertIsInstance(TestERDownloaderMiddleware.erdm.process_response(request, response, None), Response)
        self.assertEqual(PUADownloaderMiddleware.proxy, request.meta.get('proxy_source'))
        self.assertEqual(PUADownloaderMiddleware.ua, request.headers.get(b'User-Agent'))
        # Invalid response
        response = FakeResponse.get_invalid_response()
        self.assertIsInstance(TestERDownloaderMiddleware.erdm.process_response(request, response, None), Request)
        self.assertIsNone(PUADownloaderMiddleware.proxy)
        self.assertIsNone(PUADownloaderMiddleware.ua)
        request = FakeRequest.get_valid_request(meta={'retry':  ERDownloaderMiddleware.max_retry + 1})
        try:
            exception = None
            TestERDownloaderMiddleware.erdm.process_response(request, response, None)
        except IgnoreRequest as e:
            exception = e
        finally:
            self.assertIsInstance(exception, IgnoreRequest)
...
class TestCheckDownloaderMiddleware(TestCase):
    ...
    def test_process_request(self):
        ...
        request = FakeRequest.get_request(TestCheckDownloaderMiddleware.recent_scrapped_offer_url, FakeRequest.valid_proxy, FakeRequest.valid_ua)
        try:
            exception = None
            TestCheckDownloaderMiddleware.checkdm.process_request(request, None)
        except IgnoreRequest as e:
            exception = e
        finally:
            self.assertIsInstance(exception, IgnoreRequest)
        request = FakeRequest.get_request(TestCheckDownloaderMiddleware.recent_scrapped_company_url, FakeRequest.valid_proxy, FakeRequest.valid_ua)
        try:
            exception = None
            TestCheckDownloaderMiddleware.checkdm.process_request(request, None)
        except IgnoreRequest as e:
            ...
            self.assertIsInstance(exception, IgnoreRequest)
        # New requests
        request = FakeRequest.get_request(TestCheckDownloaderMiddleware.new_offer_url, FakeRequest.valid_proxy, FakeRequest.valid_ua)
        self.assertIsNone(TestCheckDownloaderMiddleware.checkdm.process_request(request, None))
        request = FakeRequest.get_request(TestCheckDownloaderMiddleware.new_company_url, FakeRequest.valid_proxy, FakeRequest.valid_ua)
        self.assertIsNone(TestCheckDownloaderMiddleware.checkdm.process_request(request, None))
        # Not recent requests
        request = FakeRequest.get_request(TestCheckDownloaderMiddleware.not_recent_scrapped_offer_url, FakeRequest.valid_proxy, FakeRequest.valid_ua)
        self.assertIsNone(TestCheckDownloaderMiddleware.checkdm.process_request(request, None))
        request = FakeRequest.get_request(TestCheckDownloaderMiddleware.not_recent_scrapped_company_url, FakeRequest.valid_proxy, FakeRequest.valid_ua)
        self.assertIsNone(TestCheckDownloaderMiddleware.checkdm.process_request(request, None))
        # Not domain url
        request = FakeRequest.get_request(TestCheckDownloaderMiddleware.not_domain_url, FakeRequest.valid_proxy, FakeRequest.valid_ua)
        try:
            exception = None
            TestCheckDownloaderMiddleware.checkdm.process_request(request, None)
        except IgnoreRequest as e:
            ...
            self.assertIsInstance(exception, IgnoreRequest)
        # Some domain url
        request = FakeRequest.get_request(TestCheckDownloaderMiddleware.some_domain_url, FakeRequest.valid_proxy, FakeRequest.valid_ua)
        self.assertIsNone(TestCheckDownloaderMiddleware.checkdm.process_request(request, None))
